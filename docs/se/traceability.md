...
| REQ-060..REQ-064 | SN-015, SN-021, SN-042 | ARCH-040..ARCH-044, CMP-007, CMP-015 | INT-018A, INT-043..INT-045 | `crates/ctx-future`, `crates/mpi/src/runtime.rs::block_on_ctx_task`, `crates/mpi/src/runtime.rs::block_on_ctx_task_with_dispatch`, `crates/mpi/src/runtime.rs::block_on_handler`, `SuspendedCall` and `SuspendedStreamNext` ctx-future integration; handler declarations use ordinary `fn` syntax and generated dispatch enters the task-runtime `CtxFuture` boundary through `block_on_handler`; generated direct awaited-assignment event handlers are lowered through `block_on_ctx_task_with_dispatch` so ordinary messages can dispatch while the awaited operation is pending | `crates/ctx-future/tests/context_borrow.rs`, `crates/mpi/tests/runtime_baseline.rs`, `crates/mpi/tests/task_macro.rs`; REQ-062 generated-dispatch progress is covered by `req_062_generated_task_receives_call_request_while_handler_is_suspended`; REQ-063 session matching has direct out-of-order response evidence; native lowering of arbitrary handler body shapes remains pending | VAL-001, VAL-004, VAL-005 | implemented |
