...
| REQ-020..REQ-028 | SN-011..SN-013, SN-020 | CMP-002, CMP-005, CMP-012 | INT-013..INT-025, INT-030..INT-032 | generated message enums, task handles, event/call/stream methods, direct queue enqueue | `crates/mpi/tests/task_macro.rs`; `crates/mpi/examples/ping_pong.rs`, `crates/mpi/examples/synchronous_call.rs`, `crates/mpi/examples/streaming_query.rs`; generated-code inspection still needed | VAL-001, VAL-003, VAL-004, VAL-007 | implemented |
