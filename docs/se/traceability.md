...
| REQ-100..REQ-114 | SN-010, SN-015, SN-016, SN-017, SN-021, SN-043 | ARCH-070..ARCH-079 | INT-070..INT-081 | stream events, consumer buffering, drop cancellation attempt, generated cancellation routing, producer credit cleanup, sink batching/end/error, late stream policy; producer suspension under backpressure remains partial | `crates/mpi/tests/runtime_baseline.rs`, `crates/mpi/tests/task_macro.rs`; REQ-112 and REQ-113 pending | VAL-007, VAL-008, VAL-009 | implemented |
