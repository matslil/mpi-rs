...
| SN-043 | REQ-095..REQ-097, REQ-100..REQ-113, REQ-115 | ARCH-070..ARCH-079, ARCH-077A | INT-070..INT-081, INT-075B | VAL-008, VAL-009 |
...
| REQ-010..REQ-015 | SN-010, SN-014, SN-040 | CMP-001..CMP-004, CMP-002A, ARCH-010..ARCH-015 | generated task API, `TaskQueue`, `TaskEndpoint`, `TaskContext` | `crates/mpi/src/queue.rs`, `crates/mpi/src/task.rs`, `crates/mpi-macros/src/lib.rs` | `crates/mpi/tests/runtime_baseline.rs`, `crates/mpi/tests/task_macro.rs`; `req_027_req_028_task_handle_uses_shared_endpoint_for_direct_enqueue`; REQ-015 inspection still needed | VAL-001, VAL-003 | implemented |
...
| REQ-100..REQ-115 | SN-010, SN-015, SN-016, SN-017, SN-021, SN-043 | ARCH-070..ARCH-079, ARCH-077A | INT-070..INT-081, INT-075A, INT-075B | stream events, consumer buffering, drop cancellation attempt, generated cancellation routing, producer credit cleanup, explicit stream-flow and stream-cancelled send errors, sink batching/end/error, producer-side native `CtxFuture` yield operations, flow-controlled generated stream sinks, late stream policy; producer suspension under backpressure is implemented for `yield_item()` and `yield_batch()` | `crates/mpi/tests/runtime_baseline.rs`, `crates/mpi/tests/task_macro.rs`, `crates/mpi/src/stream.rs` unit tests; REQ-109 and REQ-112 have explicit mapped tests; REQ-113 has producer-yield scheduler-return evidence in `req_113_stream_sink_yield_item_returns_context_after_sending_batch`; REQ-115 is covered by `req_115_stream_sink_yield_item_suspends_until_credit_arrives` and `req_115_stream_sink_yield_batch_reports_cancel_while_waiting_for_credit` | VAL-007, VAL-008, VAL-009 | implemented |
