...
| REQ-100..REQ-114 | SN-010, SN-015, SN-016, SN-017, SN-021, SN-043 | ARCH-070..ARCH-079 | INT-070..INT-081 | stream replies carry `LateReplyPolicy`; `TaskContext` invokes late-reply handlers by default and ignores them when declared; broader stream implementation remains partial | `crates/mpi/tests/runtime_baseline.rs`, `crates/mpi/tests/task_macro.rs`; broader stream flow-control verification still pending | VAL-007, VAL-008, VAL-009 | approved |
